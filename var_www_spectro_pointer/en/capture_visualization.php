...
if( $_GET["capture"] && $_GET["reference"] ) {
	...
	$plot->SetTitle("Plot of the spectrum");
...
<li><a id="menulinkactive" href="capture_visualization.php">Visualization of the specter</a></li>
<!--
...
<div align="right"><a href="<?php echo "http://sp-uc.ddns.net//"?>fr/capture_visualization.php "><img src="<?php echo $path;?>drapeau_france.png" width="25px" height="25px" alt="France"/></a> <a href="<?php echo "http://sp-uc.ddns.net//"?>en/capture_visualization.php"><img src="<?php echo $path;?>drapeau_anglais.png" width="25px" height="25px" alt="English"/></a> <a href="<?php echo "http://sp-uc.ddns.net//"?>esp/capture_visualization.php"><img src="<?php echo $path;?>drapeau_espagne.png" width="25px" height="25px" alt="Espagnol"/></a> <a href="<?php echo "http://sp-uc.ddns.net//"?>pt/capture_visualization.php"><img src="<?php echo $path;?>drapeau_portugal.png" width="25px" height="25px" alt="Portugal"/></a></div>
</ul>
</div>
...
<form method="GET">
	...
	<legend>Select a capture</legend>
		<p>
		<?php
			$table = Capture;
	...
	<fieldset id="selection_reference">
		<legend>Select a reference</legend>
		<p>
			<?php
				$table = ReferTo;
