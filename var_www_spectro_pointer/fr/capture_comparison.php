...
if($_GET["capture"]) {
	...
	$plot->SetTitle("Comparaison avec le ".$name_reference);
...
<li><a id="menulinkactive" href="capture_comparison.php">Analyse des captures</a></li>
...
<form method="GET">
	...
	<p>
		Correlation croisee : <input type="radio" name="methode_comparison" value="1" /><br/>
		Correlation standard : <input type="radio" name="methode_comparison" value="2" /><br/>
	</p>    
	<br/>
	<?php
	...
	<input type="submit" value="envoyer" id="submit_formulaire"/>
	<br/><br/>
	...
	if($_GET["capture"]){
		if($resultat>65.0){
			$conclusion="correspond à ".$name_reference;
		}
		else{
			$conclusion="ne correspond à aucune reference.<br/>Nous ne savons pas à quoi correspond cette capture.";
		}
	 	echo "<p> La reference qui correspond le plus à la capture est ".$name_reference.".  La correlation est de ".$resultat." %.<br/><b>Donc nous pouvons en conclure que cette capture ".$conclusion."</b></p>";
	}
	?>
	</div>
</form>
